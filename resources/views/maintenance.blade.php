...
<head>
    ...
    <title>GoulBAM - Maintenance</title>

    <meta name="description"
        content="Most Powerful &amp; Comprehensive Bootstrap 5 HTML Admin Dashboard Template built for developers!" />
    <meta name="keywords" content="dashboard, bootstrap 5 dashboard, bootstrap 5 design, bootstrap 5">
    <!-- Canonical SEO -->
    <link rel="canonical" href="https://goulbam.com/about">
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('userend') }}/vendor/css/pages/page-misc.css">
    <!-- Helpers -->
...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <p class="mb-4 mx-2">
                Désolé pour la gêne occasionnée mais nous effectuons une maintenance en ce moment
            </p>
            <a href="{{ url('/') }}" class="btn btn-primary">Retour à l'accueil</a>
            <div class="mt-4">
                <img src="{{ asset('userend') }}/img/illustrations/girl-doing-yoga-light.png"
