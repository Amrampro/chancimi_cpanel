                        ...
                        <div class="login-box">
                            <div class="login-content">
                                <div class="col-md-6 info">
                                    ...
                                    <h2>Welcome!</h2>
                                    <p>
                                        Position greatest so desirous. So wound stood guest weeks no terms up ought. By
                                        so these am so rapid blush songs begin. Nor but mean time one over.
                                    </p>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <input id="name" type="text"
                                                        ...
                                                        autocomplete="name" placeholder="Nom" autofocus>
