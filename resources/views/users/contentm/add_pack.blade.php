            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ url('user/emp/cm/packs') }}" method="post"
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <p><small>(N/B: SEPARER AVEC UNE VIRGULE ",". Ex: caractéristique1, caractéristique2, caractéristique3)</small></p>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea class="form-control" name="detail" id="mytextarea" cols="30" rows="10"></textarea>
                            </div>
                            <div class="mt-2">
